...
\acrodefplural{rq}[RQs]{Research Questions}
...
\begin{acronym}[XXXXXX]
    ...
    \acro{hdbscan}[HDBSCAN]{Hiercharical Density-Based Spatial Clustering of Applications with Noise}
    ...
    \acro{ctm}[CTM]{Correlated Topic Model}
    \acro{lda}[LDA]{Latent Dirichlet Allocation}
    \acro{lsa}[LSA]{Latent Semantic Analysis}
    \acro{plsa}[PLSA]{Probabilitstic Latent Semantic Analysis}
