...
\begin{document}
    ...
    \include{chapter/02-related_work}
    \include{chapter/section-02/02-methodology}
    \include{chapter/section-03/03-implementation}
    \include{chapter/section-04/04-evaluation}
