...
This section outlines implementation details of the data fed into the database, the database itself and the baseline topic modelling approach compared to this work's application.
 % Database
...
Two topic modelling approaches are outlined below.
