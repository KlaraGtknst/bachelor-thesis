...
\begin{listing}[htp]
    ...
    \end{minted}
    \caption[Conversion of RGB pixel values to greyscale]{Conversion of RGB pixel values to greyscale from a script by \thesissupervisor{} according to \cite{RGB2Grey}.}
    \label{lst:rgb2grey}
\end{listing}
...
Afterwards, the images are converted to greyscale using \lst{lst:rgb2grey} (\lst{lst:preproc_images}, line \ref{line:color}).
