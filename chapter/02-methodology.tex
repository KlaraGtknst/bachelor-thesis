...
\begin{figure}[htp] % htp = hier (h), top (t), oder auf einer eigenen Seite (p).
    \centering
    \includegraphics[width=0.5\textwidth]{images/OPTICS/model_xi/reachability_plot.pdf}
...
\begin{figure}[htp] % htp = hier (h), top (t), oder auf einer eigenen Seite (p).
    \centering
    \includegraphics[width=0.5\textwidth]{images/OPTICS/model_xi/OPTICS_cluster.pdf}
...
\begin{figure}%
    \centering
    \subfloat[\centering Example image from cluster 0. The image seems to be a normal, non-certificate document.]{{\includegraphics[width=5cm]{images/OPTICS/model_xi/example_image_cluster_0.pdf} }}%
    \qquad
    \subfloat[\centering Example image which was identified as noise. The image seems to be a certificate.]{{\includegraphics[width=5cm]{images/OPTICS/model_xi/example_image_cluster_-1.pdf} }}%
