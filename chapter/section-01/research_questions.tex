...
\begin{description}[style=unboxed]
    \item[Does a combination of visual and textual topic analysis approach facilitate the exploration of unstructured texts?]
    ...
    However, this work has a broad target audience, ranging from police officers to companies, 
    ...
    This thesis should state obstacles and possibly limitations encountered when scaling the techniques to a dataset of roughly 38 \ac{gb} of documents.
