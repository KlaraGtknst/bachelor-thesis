\subsection*{Evaluation of \acs{tfidf}}\label{subsec:evaluation-tfidf}
...
Both the default and a custom preprocessor were tested on a data corpus of 195 documents with regard to the vocabulary (size).
