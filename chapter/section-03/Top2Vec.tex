...
The approach \ac{t2v} addresses several problems of state-of-the-art topic modeling approaches \cite{Top2Vec2020}.
...
Hence, topic modeling can be defined as the task of finding sets of informative words that describe a document.
...
The steps of the topic modeling procedure \ac{t2v} are depicted in \autoref{fig:top2vec}.
...
\begin{figure}[htp] % htp = hier (h), top (t), oder auf einer eigenen Seite (p).
    ...
    \caption{Procedure of topic modeling using \ac{t2v}.}
    \label{fig:top2vec}
\end{figure}